...
export default function Sidebar({ tags, onNewTag, open, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-2 pt-2 text-xs uppercase tracking-wide text-muted">Calendar</div>
      <ul className="px-2 pb-2">
        <li>
          <Link
            ...
            onClick={onClose}
            className={`flex items-center gap-2 rounded-md px-2 py-2 text-sm transition-colors hover:bg-border ${
              location.pathname === "/calendar" ? "bg-border text-ink" : "text-ink"
            }`}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="px-4 pb-2 pt-2 text-xs uppercase tracking-wide text-muted">Planning</div>
      <ul className="px-2 pb-2">
        <li>
          <Link
            to="/planning"
            onClick={onClose}
            className={`flex items-center gap-2 rounded-md px-2 py-2 text-sm transition-colors hover:bg-border ${
              location.pathname === "/planning" ? "bg-border text-ink" : "text-ink"
            }`}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
